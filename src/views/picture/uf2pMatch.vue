        ...
        <div class="cell-item" v-for="(item,index) in data" :key="index">
          ...
          <div class="item-body">
            ...
            <div class="item-footer">
              ...
              <div class="like">
                <i></i>
                <div class="like-total" @click="showMatchInfo(item)">匹配度:{{(item.rate*100).toFixed(0)}}%</div>
              </div>
            </div>
          </div>
        </div>
...
<script>
  import {uf2pMatch} from '@/api/picture/picture.js'
